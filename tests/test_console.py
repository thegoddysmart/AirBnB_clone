#!/usr/bin/python3
"""FOr Defining our unittests on console.py.
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests using in testing destroy method from the HBNB commandline interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """Unittests used in testing all the HBNB commandline interpreter,"""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unittests used in testing the update from our HBNB commandline interpreter,"""
...
class TestHBNBCommand_count(unittest.TestCase):
    """Unittests used in testing the method of HBNB comandline interpreter,"""
